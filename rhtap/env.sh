...
export GITOPS_REPO_URL=https://github.com/rhtap-qe-jsmid/owmdx3xjb-python-gitops
...
export REKOR_HOST=${REKOR_HOST-https://rekor-server-rhtap-tas.apps.cluster-5zgb6.5zgb6.sandbox2670.opentlc.com}
...
export TUF_MIRROR=${TUF_MIRROR-https://tuf-rhtap-tas.apps.cluster-5zgb6.5zgb6.sandbox2670.opentlc.com}
...
export COSIGN_PUBLIC_KEY=LS0tLS1CRUdJTiBQVUJMSUMgS0VZLS0tLS0KTUZrd0V3WUhLb1pJemowQ0FRWUlLb1pJemowREFRY0RRZ0FFc2dHenNIYm5sanRsby9CNUc2OGQyc3RadUo5UQpibGQ3VS91MnhyaStPcUhESDlqcDNjcnNPWitnOFBISVQ0K0dlVnpRRjUwZEduMERNRy9xbkU0cjZRPT0KLS0tLS1FTkQgUFVCTElDIEtFWS0tLS0tCg==
